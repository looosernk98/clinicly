...
const AddDoctor = () => {
    ...
    const onSubmitHandler = async (event) => {
        ...
        try {
            ...
            const clinicAddress = { line1: address1, line2: address2 }
            ...
            formData.append('consultation_fee', Number(fees))
            formData.append('about', about)
            formData.append('specialization', speciality)
            formData.append('degree', degree)
            formData.append('clinic_address', JSON.stringify(clinicAddress))

            // Backward-compatible fields for current backend controllers
            formData.append('name', fullName)
            formData.append('speciality', speciality)
            formData.append('fees', Number(fees))
            formData.append('address', JSON.stringify(clinicAddress))
