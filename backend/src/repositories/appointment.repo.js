...
class AppointmentRepository {
    ...
    async getStats(filters = {}) {
        ...
        const completedAppointments = await appointmentModel.countDocuments({ ...filters, isCompleted: true })
        const cancelledAppointments = await appointmentModel.countDocuments({ ...filters, cancelled: true })
        const paidAppointments = await appointmentModel.countDocuments({ ...filters, payment: true })
